...
*** "WIP"
*** "NEXT"
** TODO How to manage package version pinning in =straight.el=?
** TODO Package regression: clojure-mode: =end-of-defun= skips two top level forms
** TODO Package regression: org-mode: easy templates don't expand
** TODO Implement =grc= in elisp
** TODO Get Eshell/tramp to cache and/or save passwords [2/3]
...
** TODO Fix Eshell bouncing shell output up and down
