...
** TODO term-mode filter out escape sequence
   =]0;fish=
   Guessing this is the xterm sequence to set the title?
** TODO =copy-region-oter-window= and =move-region-other-window= should also copy the line if no region is selected
